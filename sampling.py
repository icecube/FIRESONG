...
class InverseCDF(object):
    ...
    The object has a method 'sample' that gives random numbers according to the pdf.
    """
    ...
    def sample(self, N=None):
        """ Returns random number variable(s) distributed according to PDF used at construction.
        At construction time the seed can be set. 
